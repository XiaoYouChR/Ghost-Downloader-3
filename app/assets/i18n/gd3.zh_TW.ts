...
資料將被複製到新位置，程式隨後退出。請手動重新開啟。</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation type="vanished">壓縮檔包含不安全的路徑：{path}</translation>
        </message>
        <message>
            <source>压缩包未找到：{path}</source>
            <translation type="vanished">找不到壓縮檔：{path}</translation>
        </message>
        <message>
            <source>不支持的压缩格式：{name}</source>
            <translation type="vanished">不支援的壓縮格式：{name}</translation>
        </message>
        <message>
            <source>解压后未找到可执行文件：{name}</source>
            <translation type="vanished">解壓縮後找不到可執行檔：{name}</translation>
        </message>
        <message>
            <source>无法读取校验文件：{path}</source>
            <translation type="vanished">無法讀取校驗檔案：{path}</translation>
        </message>
        <message>
            <source>SHA256 校验失败：期望 {expected}，实际 {actual}</source>
            <translation type="vanished">SHA256 校驗失敗：應為 {expected}，實際為 {actual}</translation>
        </message>
        <message>
            <source>下载的文件未找到：{path}</source>
            <translation type="vanished">下載的檔案找不到：{path}</translation>
        </message>
        <message>
