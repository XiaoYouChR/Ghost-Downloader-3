...
Os dados serão copiados para o novo local e o programa será encerrado. Reabra manualmente.</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation type="vanished">O arquivo compactado contém um caminho inseguro: {path}</translation>
        </message>
        <message>
            <source>压缩包未找到：{path}</source>
            <translation type="vanished">Arquivo compactado não encontrado: {path}</translation>
        </message>
        <message>
            <source>不支持的压缩格式：{name}</source>
            <translation type="vanished">Formato de compactação não suportado: {name}</translation>
        </message>
        <message>
            <source>解压后未找到可执行文件：{name}</source>
            <translation type="vanished">Arquivo executável não encontrado após extração: {name}</translation>
        </message>
        <message>
            <source>无法读取校验文件：{path}</source>
            <translation type="vanished">Não foi possível ler o arquivo de verificação: {path}</translation>
        </message>
        <message>
            <source>SHA256 校验失败：期望 {expected}，实际 {actual}</source>
            <translation type="vanished">Falha na verificação SHA256: esperado {expected}, obtido {actual}</translation>
        </message>
        <message>
            <source>下载的文件未找到：{path}</source>
            <translation type="vanished">Arquivo baixado não encontrado: {path}</translation>
        </message>
        <message>
