...
disableButton.addEventListener("click", () => {
    browser.storage.local.set({ shouldDisableExtension: true }, () => {
...
enableButton.addEventListener("click", () => {
    browser.storage.local.set({ shouldDisableExtension: false }, () => {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 获取客户端版本和最新插件版本
    browser.storage.local.get(["ClientVersion", "LatestExtensionVersion"], (result) => {
