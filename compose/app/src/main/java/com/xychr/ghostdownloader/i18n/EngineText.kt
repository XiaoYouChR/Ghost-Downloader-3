 ...
 */
fun Context.engineText(template: String, params: Map<String, String> = emptyMap()): String {
...
@Composable
fun engineText(template: String, params: Map<String, String> = emptyMap()): String =
...
fun Throwable.toTaskError(): TaskError {
    ...
    return TaskError("发生了意外错误：{detail}", mapOf("detail" to stripped.ifEmpty { this::class.simpleName.orEmpty() }))
}
